...
Parmis les modèles les plus populaires, on peut citer:
  ...
  - **EfficientNet**: Famille de modèle très récente, ils sont très performants et très légers : c'est le meilleur moyen d'atteindre de très bonnes performances rapidement.
